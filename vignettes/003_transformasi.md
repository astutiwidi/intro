...
1.  gather: membuat nama kolom menjadi data karena kita melihat bahwa
    ada nama kolom yang seharusnya merupakan data
2.  select : memilih kolom yang dianggap perlu
3.  group\_by : mengubah tabel menjadi sebuah grouped table yang
    memudahkan operasi secara grup
4.  summarise : merangkum data. Pada kasus ini, merangkum jumlah case
    untuk tahun dan negara yang sama , kemudian fungsi na.rm digunakan
    untuk menanganimissing value
5.  ungroup: menghilangkan grouping yang dilakukan oleh group\_by
6.  left\_join ;menggabungkan dua tabel ke dalam 1 tabel
7.  filter: memilih baris data yang memenuhi kondisi tertentu. Dalam
    kasus ini, baris yang kolom populasinya tidak na
8.  mutate ; menambahkan kolom baru, dalam kasus ini kolom proporsion,
    yang berisi 100x cases/population
...
Kedua data tsb sama. yang tb\_all lebih rapi penulisannya, tapi perlu
pembiasaan
